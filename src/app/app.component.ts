  ...
  constructor(public platform: Platform,
    ...
    this.platform.ready().then(() => {
      ...
      if(!this.platform.is('cordova')){
       ...
       //firebase.auth().onAuthStateChanged((user) => { //added by pranjali
        ...
        NativeStorage.getItem('initialOpening').then(data => {
          ...
          PushNotification.hasPermission().then((data) => {
            ...
            if (user && !this.initialOpening && this.pNsEnabled) {
              ...
              this.rootPageProvider.setRootPage(TabsPage, {}, {}); //IntroductionPag
            } else{
              this.rootPageProvider.setRootPage(LoginPage, {"initial": true}, {}); //LoginPage
            }
          });
        });
      });
